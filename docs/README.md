...
- [ ] 사용자에게 페어를 매칭할 과정, 레벨, 미션을 콤마로 구분받아 입력받는다.
    - [ ] 없는 과정, 레벨, 미션을 입력한 경우 에러 메시지 출력 후 재입력받는다.
    - [ ] 콤마로 구분되지 않거나, 3의 데이터를 입력하지 않은 경우 에러 메시지 출력 후 재입력받는다.
...
- [ ] 사용자에게 과정, 레벨, 미션을 콤마로 구분 받아 입력받는다.
    - [ ] 없는 과정, 레벨, 미션을 입력한 경우 에러 메시지 출력 후 재입력받는다.
    - [ ] 콤마로 구분되지 않거나, 3의 데이터를 입력하지 않은 경우 에러 메시지 출력
- [ ] 매칭이력이 없으면 없다고 안내한다.

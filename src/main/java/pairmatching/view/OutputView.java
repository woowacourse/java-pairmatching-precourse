...
public class OutputView {
	...
	public static final String NO_PAIR_EXIST_ERROR_MESSAGE = "[ERROR] 존재하는 페어가 없습니다.";
	...
	public static void printPairResult(Pairs pairList) {
		...
		for (Pair pair : pairList.pairList) {
			if (pair.existCrew3()) {
				System.out.println(
					pair.getCrew1().getName() + " : " + pair.getCrew2().getName() + " : " + pair.getCrew3().getName());
				return;
			}
	...
	public static void printNoExistError() {
		System.out.println(NO_PAIR_EXIST_ERROR_MESSAGE);
	}
}

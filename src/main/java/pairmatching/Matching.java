...
public class Matching {
	...
	public static ArrayList<ArrayList<String>> crewTotalNumber(List<String> CrewNames, Course course, Level level) {
		...
		if (CrewNames.size() % 2 != 0) {
			if(!pairMatching(CrewNames, CrewNames.size() - 3, CrewMatching, beforepairIndexs)|| !pairthreeMatching(CrewNames, CrewMatching, beforepairIndexs)){
				return null;
			}// 홀수면 마지막 세명이 매칭
		}
		return CrewMatching;
	...
	// 크루 2명씩 매칭
	private static boolean pairMatching(List<String> CrewNames, int crewListSize, ArrayList<ArrayList<String>> crewMatching, ArrayList<Integer> metBeforeList) {
	...
	// 크루 3명 매칭
	public static boolean pairthreeMatching(List<String> CrewNames, ArrayList<ArrayList<String>> crewMatching, ArrayList<Integer> metBeforeList) {

...
## 🚀 기능 요구사항
- 페어 매칭
  - Course, Level, Mission 별로 pair가 정해진다.
  - 미션을 함께 수행할 페어를 두명씩 매칭한다.
  - 페어 매칭 대상이 홀수인 경우 한 페어는 3인으로 구성한다.
  - 같은 레벨에서 이미 페어를 맺은 크루와는 다시 페어로 매칭될 수 없다.
  - [예외사항] `3회 시도`까지 매칭이 되지 않는 경우 :
  - [예외사항] 매칭을 할 수 있는 `경우의 수가 없는` 경우
  - [예외사항] `존재하지 않는 미션`에 대한 페어 매칭 요청

- 페어 조회
  - [예외사항] 매칭 결과가 없는 경우 : [ERROR] 매칭 이력이 없습니다.
